...
public class InkView extends View {
    ...
    private SizedStack<Bitmap> undoStack;
    ...
    public boolean undo() {
        if(undoStack.empty()) {
            ...
            this.clear();
            Bitmap bm = undoStack.pop();
            this.drawBitmap(bm, 0, 0, null);
            Log.d("inkdraw", "POP: " + undoStack.size());
            return true;
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            ...
            Log.d("inkdraw", "onDown: " + undoStack.size());
